...
variable "aws_vpn_gateway" {
  type        = string
  description = "The aws_vpn_gateway"
}

variable "vpn_route_table_private" {
  type        = string
  description = "The route_table_private"
}

variable "vpn_route_table_public" {
  type        = string
  description = "The route_table_public"
}
...
variable "vpn_connection_tunnel2_phase_1_lifetime" {
  description = "Set vpn_connection_tunnel2_phase_1_lifetime"
  type        = string
  default     = ""
}
...
variable "vpn_connection_tunnel2_phase_2_lifetime" {
  description = "Set vpn_connection_tunnel2_phase_2_lifetime"
  type        = string
  default     = ""
}
